...
public class ExpenseDTO {
    ...
    // DB 컬럼은 아니고, 반복 지출이 화면에서 자동 생성된 항목인지 구분하기 위한 값
    ...
    public String getAutoGeneratedYn() { return autoGeneratedYn; }
    public void setAutoGeneratedYn(String autoGeneratedYn) { this.autoGeneratedYn = autoGeneratedYn; }
