...
public class ExpenseRepositoryImpl implements ExpenseRepository {
    ...
    @Override
    public List<ExpenseDTO> selectExpenseList(Long memberId, String yearMonth) {
    ...
    public void deleteExpense(Long expenseId, Long memberId) {
        jdbcTemplate.update(deleteExpenseSql, expenseId, memberId);
    }
    ...
    private ExpenseDTO copyAsRepeatedExpense(ExpenseDTO base, LocalDate repeatedDate) {
        ...
        repeated.setMemberId(base.getMemberId());
        ...
        repeated.setCreatedAt(base.getCreatedAt());
