...
public class MemberRepositoryImpl implements MemberRepository{
    ...
    private final String selectMemberByIdSql = "SELECT member_id, id, email, password, member_name, nickname, phone, login_type, blocked_until, warning_count, role, status, verify_type, open_bank_user_seq_no, open_bank_token, "
    + "TO_CHAR(created_at, 'YYYY-MM-DD') AS created_at, "
    + "TO_CHAR(updated_at, 'YYYY-MM-DD') AS updated_at, "
    + "TO_CHAR(last_login_at, 'YYYY-MM-DD') AS last_login_at "
    + "FROM member_tb WHERE id = ?";
