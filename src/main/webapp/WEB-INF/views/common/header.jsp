...
<header class="site-header">
    <div class="container header-inner">
        ...
        <nav class="nav">
            ...
            <a href="${contextPath}/spendolive/expense/list.do" class="${fn:contains(requestURI, '/expense') ? 'active' : ''}">지출관리</a>
            <a href="${contextPath}/spendolive/calendar.do" class="${fn:contains(requestURI, '/calendar') ? 'active' : ''}">캘린더</a>
            <a href="${contextPath}/spendolive/ott.do" class="${fn:contains(requestURI, '/ott') ? 'active' : ''}">OTT관리</a>
            <a href="${contextPath}/spendolive/mypage.do" class="${fn:contains(requestURI, '/mypage') ? 'active' : ''}">마이페이지</a>
        </nav>
