...
CREATE TABLE settlement_refund_tb (
    ...
    payment_id      NUMBER NOT NULL,
    settlement_id   NUMBER NOT NULL,
    room_id         NUMBER NOT NULL, -- 환불 대상 OTT 방 ID
...
-- 중복 인덱스 생성문 제거: CREATE INDEX idx_refund_payment ON settlement_refund_tb(payment_id);
-- 중복 인덱스 생성문 제거: CREATE INDEX idx_refund_member_login ON settlement_refund_tb(member_login_id, refund_status);
